...
- Upload the MCU code (ECGtest.ino) using Arduino IDE 2.x
- Connect electrode leads to the module and position electrodes correctly on the body
- Open the serial monitor and watch the signals in real time!
